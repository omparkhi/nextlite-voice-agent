"""Dynamic multi-tenant schedule and slot generation engine.
...
def parse_business_shifts(business_hours: Optional[str]) -> List[Tuple[int, int]]:
    ...
    Examples:
        - "Morning 10:00 AM to 01:00 PM and Evening 06:00 PM to 09:00 PM. Afternoon Break (01:00 PM to 06:00 PM) is strictly closed."
          -> [(600, 780), (1080, 1260)] (10:00-13:00 and 18:00-21:00)
        - "Monday to Friday: 09:00 AM to 05:00 PM"
          -> [(540, 1020)] (09:00-17:00)
        - "10:00 AM - 08:00 PM"
          -> [(600, 1200)]
    """
    ...
    # Look for explicit shift ranges: "10:00 AM to 01:00 PM", "06:00 PM to 09:00 PM", "9am - 5pm"
    # Matches: (Time 1) (to|-|–|until) (Time 2)
    ...
    if found_shifts:
        # Merge overlapping/adjacent shifts and sort
...
def generate_dynamic_slots(
    ...
    # Normalize booking_date if relative
    is_today = False
    if booking_date:
    ...
    for start_min, end_min in shifts:
        ...
        while cursor < end_min:
            # Check if this slot has already passed for today
